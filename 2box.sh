#!/bin/sh
BASEPARAM="--model /media/devel/models/2box/2box.obj --light 0 1.7 0 1 --camera-speed 0.1 --camera-remember --method rssv --window-size 1024 1024"
TRI=" traverseTriangles   0 computeLastLevelTriangles   1 exactTriangleAABB   1 computeTriangleBridges   1 "
